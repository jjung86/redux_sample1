          ...
          reminders.map(reminder => {
            return(
              <li key={reminder.id} className="list-group-item">
                ...
                <div className="list-item delete-button" onClick={() => this.deleteReminder(reminder.id)} style={ {cursor : 'pointer'}}>
                  &#x2715;
                </div>
              </li>
            )
      ...
      <div className="App">
        ...
        <div className="form-inline reminder-form">
          <div className="form-group">
            <input className="form-control" placeholder="I hava to..." onChange={event => this.setState({ text: event.target.value })} />
